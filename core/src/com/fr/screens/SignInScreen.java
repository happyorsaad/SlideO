...
public class SignInScreen implements Screen {
	...
	public SignInScreen(SkiFall gameRef) {
		...
		this.skipButton = new Rectangle(240 - 250 / 2, 250 - 75 / 2, 250, 75);
	...
	private void updateScreen(float delta) {
		...
		if (gameRef.actionResolver.getSignedInGPGS()) {
			SkiFall.helpScreen.onDoneScreen = SkiFall.gameScreen;
